...
header_file_text = open( source_directory + "/" + class_name + '.h'  , 'r').read()
cpp_file_text    = open( source_directory + "/" + class_name + '.cpp', 'r').read()
...
header_file = open(  source_directory + "/" + class_name + '.h', 'r')
