...
public:
  ...
  virtual void EditColsRows(int *cols, int *rows) const {
    ...
    *cols *= panel_stretch_factor_;
    printf( "panel_stretch_factor: %d  panel_rows: %d  panel_cols: %d \n", panel_stretch_factor_, panel_rows_, panel_cols_ );
  }
  ...
  virtual void MapVisibleToMatrix(int matrix_width, int matrix_height,
    ...
    if ( visible_y < 32 ) {
        ...
        *matrix_y = parallel_panel * panel_rows_ / panel_stretch_factor_ + new_y - visible_y - 1;
    } else {
        *matrix_x = chained_panel  * panel_stretch_factor_* panel_cols_ + new_x - visible_x - 1;
        *matrix_y = parallel_panel * panel_rows_ / panel_stretch_factor_ + new_y - visible_y - 1;
    }
