I want to make a factory for a Drawer Object.  The Drawer Object is use in this ScoreBoard class:
```cpp
...
It is used to make object like the bluePipeDrawer and the bigNumberDrawer.

Here is the Drawer class:
```cpp
...
Please write the header and C++ files to build a Drawer Factory.