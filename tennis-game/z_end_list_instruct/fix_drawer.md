# Your role
Find out why there is a red squiggly under the DrawText word in the DrawText method in the Source Code below.  Fix the problem.

In the DrawText method, in this line of code there is a red squiggly under the DrawText word:
```cpp
