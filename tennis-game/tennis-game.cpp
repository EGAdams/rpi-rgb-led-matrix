...
// #include <bitset> // do we need this in here twice?  121424
...
// libraries needed for the keyboard to listen to input while at the same time,
// the remote is also listening to input.
#include <thread>
#include <atomic>
#include <mutex>
