...
int main(int argc, char *argv[]) {
  ...
  rgb_matrix::DrawText(canvas, big_number_font, x + SPACE_BEFORE_2ND_NUMBER, y + big_number_font.baseline() + 2, secondRowColor, outline_font ? NULL : &bg_color, " Ad", letter_spacing );
  ...
  rgb_matrix::DrawText(canvas, little_number_font, x + SPACE_BEFORE_SMALL_NUMBER + (( 2 * SPACE_BETWEEN_SMALL_NUMBERS ) + 1 ), y + little_number_font.baseline(), fourthRowColor, outline_font ? NULL : &bg_color, "0", letter_spacing );
