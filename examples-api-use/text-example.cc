...
int main(int argc, char *argv[]) {
  ...
  rgb_matrix::DrawText(canvas, font,        PERIOD_SPACING, y + font.baseline(), firstRowColor, outline_font ? NULL : &bg_color, "56", letter_spacing );
  y += font.height();

  Color secondRowColor( 255, 0, 0 );
  rgb_matrix::DrawText(canvas, period_font, x, y + font.baseline(), period_color,   outline_font ? NULL : &bg_color, ". ", letter_spacing );
  rgb_matrix::DrawText(canvas, font,        PERIOD_SPACING, y + font.baseline(), secondRowColor, outline_font ? NULL : &bg_color, "78", letter_spacing );
  y += font.height();

  Color thirdRowColor( 0, 255, 0 );
  rgb_matrix::DrawText(canvas, period_font, x, y + font.baseline(), period_color,  outline_font ? NULL : &bg_color, ". ", letter_spacing );
  rgb_matrix::DrawText(canvas,        font, PERIOD_SPACING, y + font.baseline(), thirdRowColor, outline_font ? NULL : &bg_color, "91", letter_spacing );
  y += font.height();
