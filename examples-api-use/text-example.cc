...
int main(int argc, char *argv[]) {
  ...
  #define COORDS_FOR_SECOND_NUMBER 28
  #define PIPE_SPACE 1
  ...
  rgb_matrix::DrawText(canvas, big_number_font, x + SPACE_BEFORE_1ST_NUMBER, y + big_number_font.baseline(), firstRowColor, outline_font ? NULL : &bg_color, "1", LETTER_SPACING );
  rgb_matrix::DrawText(canvas, big_number_font, x + COORDS_FOR_SECOND_NUMBER, y + big_number_font.baseline(), firstRowColor, outline_font ? NULL : &bg_color, "5", LETTER_SPACING );
  ...
  rgb_matrix::DrawText(canvas, little_number_font, x + SPACE_BEFORE_2ND_NUMBER, y + little_number_font.baseline(), fourthRowColor, outline_font ? NULL : &bg_color, "3 6 1", letter_spacing );
